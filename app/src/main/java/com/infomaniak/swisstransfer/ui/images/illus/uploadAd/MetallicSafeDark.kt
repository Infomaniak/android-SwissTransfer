...
val AppIllus.MetallicSafeDark: ImageVector
    get() {
        if (_metallicSafeDark != null) {
            return _metallicSafeDark!!
        }
        _metallicSafeDark = Builder(
            name = "MetallicSafeDark",
            ...
            path(
                ...
                moveTo(140.75f, 66.25f)
                horizontalLineToRelative(129.5f)
                verticalLineToRelative(143.5f)
                horizontalLineToRelative(-129.5f)
                close()
            }
            path(
            ...
            path(
                ...
                arcTo(2.5f, 2.5f, 112.32f, false, true, 178.42f, 107.89f)
            ...
            path(
                ...
                moveTo(206.5f, 139.0f)
                moveToRelative(-23.75f, 0.0f)
                arcToRelative(23.75f, 23.75f, 0.0f, true, true, 47.5f, 0.0f)
                arcToRelative(23.75f, 23.75f, 0.0f, true, true, -47.5f, 0.0f)
            }
            path(
...
private var _metallicSafeDark: ImageVector? = null
