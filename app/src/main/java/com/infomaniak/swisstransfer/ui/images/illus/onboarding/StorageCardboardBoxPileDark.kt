    ...
    get() {
        ...
        _storageCardboardBoxPileDark = Builder(
            ...
            path(
                ...
                moveTo(92.0f, 0.0f)
                horizontalLineToRelative(154.0f)
            ...
            path(
                ...
                moveTo(48.0f, 129.0f)
                lineTo(62.0f, 129.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 63.0f, 130.0f)
                lineTo(63.0f, 130.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 62.0f, 131.0f)
                lineTo(48.0f, 131.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 47.0f, 130.0f)
                lineTo(47.0f, 130.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 48.0f, 129.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF67DD95)),
                ...
                moveTo(48.0f, 133.0f)
                lineTo(70.0f, 133.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 71.0f, 134.0f)
                lineTo(71.0f, 134.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 70.0f, 135.0f)
                lineTo(48.0f, 135.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 47.0f, 134.0f)
                lineTo(47.0f, 134.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 48.0f, 133.0f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFF2B383B)),
