...
val AppIllus.GhostPointingReportLight: ImageVector
    get() {
        if (_ghostPointingReport != null) {
            return _ghostPointingReport!!
        }
        _ghostPointingReport = Builder(
            name = "GhostPointingReport",
...
private var _ghostPointingReport: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.GhostPointingReportLight,
