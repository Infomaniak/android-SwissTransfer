...
fun UploadOngoingScreen(
    ...
    BottomStickyButtonScaffold(
        ...
        Column(
            ...
            Text(text = stringResource(com.infomaniak.swisstransfer.R.string.uploadProgressIndication), style = SwissTransferTheme.typography.h2)
    ...
    Crossfade(
        ...
        Box(
            ...
            CompositionLocalProvider(value = LocalTextStyle provides style) {
                ...
                when (status) {
                    UploadState.Ongoing.Status.Initializing -> Text(stringResource(com.infomaniak.swisstransfer.R.string.transferInitializing))
...
private fun CancelUploadBottomSheet(onCancel: () -> Unit, closeButtonSheet: () -> Unit) {
    SwissTransferBottomSheet(
        title = stringResource(com.infomaniak.swisstransfer.R.string.uploadCancelConfirmBottomSheetTitle),
        imageVector = AppIllus.RedCrossPaperPlanes.image(),
        topButton = {
            LargeButton(
                title = stringResource(com.infomaniak.swisstransfer.R.string.buttonCancelTransfer),
                modifier = it,
        ...
        bottomButton = {
            LargeButton(
                title = stringResource(com.infomaniak.swisstransfer.R.string.buttonCloseAndContinue),
                modifier = it,
...
private fun LocationBottomSheet(closeButtonSheet: () -> Unit) {
    SwissTransferBottomSheet(
        title = stringResource(com.infomaniak.swisstransfer.R.string.sorry),
        description = stringResource(com.infomaniak.swisstransfer.R.string.restrictedLocation),
        imageVector = AppIllus.MascotSearching.image(),
        bottomButton = {
            LargeButton(
                title = stringResource(com.infomaniak.swisstransfer.R.string.contentDescriptionButtonClose),
                modifier = it,
