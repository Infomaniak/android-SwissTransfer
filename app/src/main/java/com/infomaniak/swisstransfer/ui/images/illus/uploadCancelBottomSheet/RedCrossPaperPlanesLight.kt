...
val AppIllus.RedCrossPaperPlanesLight: ImageVector
    get() {
        if (_redCrossPaperPlanesLight != null) {
            return _redCrossPaperPlanesLight!!
        }
        _redCrossPaperPlanesLight = Builder(
            name = "RedCrossPaperPlanesLight",
            ...
            path(
                ...
                lineTo(84.15f, 61.89f)
                lineTo(83.94f, 62.02f)
                close()
                moveTo(77.8f, 94.11f)
            ...
            path(
                ...
                lineTo(16.81f, 70.83f)
                lineTo(18.88f, 60.53f)
                close()
                moveTo(18.09f, 60.53f)
                lineTo(20.15f, 70.83f)
                lineTo(20.94f, 70.67f)
                lineTo(18.87f, 60.37f)
                close()
...
private var _redCrossPaperPlanesLight: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.RedCrossPaperPlanesLight,
