...
val AppIllus.MascotWithMagnifyingGlassDark: ImageVector
    get() {

        if (_mascotWithMagnifyingGlassDark != null) return _mascotWithMagnifyingGlassDark!!

        _mascotWithMagnifyingGlassDark = Builder(
            name = "MascotWithMagnifyingGlassDark",
            ...
            path(
                fill = SolidColor(Color(0xFF333333)), stroke = SolidColor(Color(0xFFDCE4E5)),
                strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
            ...
            path(
                ...
                moveTo(157.98f, 97.35f)
                curveTo(160.73f, 94.39f, 165.36f, 94.23f, 168.31f, 96.98f)
                lineTo(178.3f, 106.28f)
                lineTo(168.34f, 116.98f)
                lineTo(158.35f, 107.68f)
                curveTo(155.4f, 104.93f, 155.23f, 100.3f, 157.98f, 97.35f)
                close()
            }
            path(
                fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFDCE4E5)),
                ...
                moveTo(178.3f, 106.28f)
                lineTo(168.31f, 96.98f)
                curveTo(165.36f, 94.23f, 160.73f, 94.39f, 157.98f, 97.35f)
                verticalLineTo(97.35f)
                curveTo(155.23f, 100.3f, 155.4f, 104.93f, 158.35f, 107.68f)
                lineTo(168.34f, 116.98f)
            }
        }.build()

        return _mascotWithMagnifyingGlassDark!!
    }

private var _mascotWithMagnifyingGlassDark: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.MascotWithMagnifyingGlassDark,
