...
val AppIllus.GhostScanningSquareLight: ImageVector
    get() {
        if (_ghostScanningSquareLight != null) {
            return _ghostScanningSquareLight!!
        }
        _ghostScanningSquareLight = Builder(
            name = "GhostScanningSquareLight",
            ...
            viewportHeight = 160.0f,
                ...
                path(
                    ...
                    stroke = SolidColor(Color(0xFF014958)),
                    strokeLineWidth = 0.898876f,
                    strokeLineCap = Butt,
                    strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f,
                    pathFillType = NonZero,
                ) {
                    moveTo(96.13f, 69.66f)
                    lineTo(113.71f, 87.25f)
                    verticalLineTo(149.2f)
                    lineTo(97.73f, 141.3f)
                    lineTo(97.53f, 141.21f)
                    lineTo(97.33f, 141.3f)
                    lineTo(80.9f, 149.43f)
                    lineTo(64.47f, 141.3f)
                    lineTo(64.27f, 141.21f)
                    lineTo(64.07f, 141.3f)
                    lineTo(48.09f, 149.2f)
...
private var _ghostScanningSquareLight: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.GhostScanningSquareLight,
