...
sealed interface ThemedLottieMethod {
    ...
    data class Theme(@RawRes val res: Int, val themeId: String?) : ThemedLottieMethod
}
...
private enum class Page(
    ...
    SendFiles(
        background = AppIllus.RadialGradientCornerTopLeft,
        illustration = ThemedLottieMethod.Qualifier(R.raw.two_locks_intertwined_stars), // TODO: Wait for real asset
