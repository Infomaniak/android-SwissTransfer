...
val AppIllus.DataProtectionLight: ImageVector
    get() {

        if (_dataProtectionLight != null) return _dataProtectionLight!!

        _dataProtectionLight = Builder(
            name = "DataProtectionLight",
            ...
            path(
                fill = SolidColor(Color(0xFFFAFAFA)), stroke = SolidColor(Color(0xFF9F9F9F)),
            ...
            path(
                ...
                curveTo(33.82f, 74.53f, 35.83f, 73.79f, 36.87f, 73.26f)
                curveTo(40.23f, 71.57f, 43.69f, 70.38f, 47.41f, 69.76f)
                ...
                curveTo(39.71f, 69.51f, 45.56f, 68.21f, 51.3f, 67.45f)
            ...
            path(
                fill = SolidColor(Color(0xFFF1F1F1)), stroke = SolidColor(Color(0xFF9F9F9F)),
                strokeLineWidth = 0.5f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
            ...
            path(
                ...
                curveTo(14.19f, 19.74f, 13.57f, 19.28f, 13.09f, 18.69f)
                ...
                curveTo(20.36f, 13.02f, 20.98f, 14.09f, 21.15f, 15.28f)
                ...
                curveTo(14.4f, 12.89f, 15.25f, 12.39f, 16.2f, 12.25f)
            ...
            path(
                ...
                curveTo(11.67f, 16.22f, 11.44f, 16.05f, 11.2f, 16.08f)
                lineTo(10.3f, 16.19f)
                close()
            }
            path(
            ...
            path(
                ...
                curveTo(21.63f, 15.47f, 21.86f, 15.65f, 22.11f, 15.62f)
                lineTo(23.0f, 15.51f)
        ...
        return _dataProtectionLight!!
    }

private var _dataProtectionLight: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.DataProtectionLight,
