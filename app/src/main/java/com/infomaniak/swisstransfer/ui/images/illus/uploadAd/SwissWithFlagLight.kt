...
val AppIllus.SwissWithFlagLight: ImageVector
    get() {
        if (_swissWithFlagLight != null) {
            return _swissWithFlagLight!!
        }
        _swissWithFlagLight = Builder(
            name = "SwissWithFlagLight",
...
private var _swissWithFlagLight: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.SwissWithFlagLight,
