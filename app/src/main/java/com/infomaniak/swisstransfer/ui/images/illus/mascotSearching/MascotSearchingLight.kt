...
val AppIllus.MascotSearchingLight: ImageVector
    get() {

        if (_mascotSearchingLight != null) return _mascotSearchingLight!!

        _mascotSearchingLight = Builder(
            name = "MascotSearchingLight",
            ...
            path(
                ...
                moveTo(193.98f, 86.47f)
                curveTo(195.0f, 86.86f, 196.08f, 87.11f, 197.22f, 87.19f)
                curveTo(204.19f, 87.7f, 210.31f, 81.81f, 210.88f, 74.03f)
                curveTo(211.44f, 66.26f, 206.25f, 59.54f, 199.28f, 59.03f)
                curveTo(198.14f, 58.95f, 197.03f, 59.03f, 195.97f, 59.27f)
                curveTo(191.98f, 62.04f, 189.16f, 66.82f, 188.75f, 72.42f)
                curveTo(188.34f, 78.02f, 190.43f, 83.15f, 193.98f, 86.47f)
                close()
            }
            path(
            ...
            path(
                ...
                moveTo(156.98f, 88.47f)
                curveTo(158.0f, 88.86f, 159.08f, 89.11f, 160.22f, 89.19f)
                curveTo(167.19f, 89.7f, 173.31f, 83.81f, 173.88f, 76.03f)
                curveTo(174.44f, 68.26f, 169.25f, 61.54f, 162.28f, 61.03f)
                curveTo(161.14f, 60.95f, 160.03f, 61.03f, 158.97f, 61.27f)
                curveTo(154.98f, 64.04f, 152.16f, 68.82f, 151.75f, 74.42f)
                curveTo(151.34f, 80.02f, 153.43f, 85.15f, 156.98f, 88.47f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth =
        ...
        return _mascotSearchingLight!!
    }

private var _mascotSearchingLight: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.MascotSearchingLight,
