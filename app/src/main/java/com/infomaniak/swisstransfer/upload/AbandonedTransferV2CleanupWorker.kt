...
import com.infomaniak.multiplatform_swisstransfer.managers.UploadV2Manager.UploadConclusion
...
class AbandonedTransferV2CleanupWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        return runCatching {
            uploadManager.finalizeTransfer(
                transferId = transferId,
                conclusion = if (failed) UploadConclusion.Failed else UploadConclusion.Cancelled
            )
            Result.success()
