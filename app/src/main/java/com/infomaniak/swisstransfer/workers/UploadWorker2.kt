...
@HiltWorker
class UploadWorker2 @AssistedInject constructor(
    ...
    private val uploadSessionAsync: CompletableDeferred<UploadSession> = CompletableDeferred()

    override suspend fun doWork(): Result {

        val uploadSession: UploadSession = uploadManager.getLastUpload() ?: run {
            SentryLog.w(TAG, "No upload pending")
            return Result.failure()
        }
        uploadSessionAsync.complete(uploadSession)
    ...
    override suspend fun getForegroundInfo(): ForegroundInfo {
        ...
        val uploadSession = uploadSessionAsync.await()
        val totalSize = uploadSession.files.sumOf { it.size }
    ...
    class Scheduler @Inject constructor(
        ...
        fun scheduleWork(uploadSessionUuid: String) {
            ...
            val workRequest = OneTimeWorkRequestBuilder<UploadWorker2>()
